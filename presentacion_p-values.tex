...
\begin{tabular}{cc}
    \begin{minipage}[c]{0.5\linewidth}
      \includegraphics[width=5.5cm]{images/tesis.png}
    \end{minipage} &   \begin{minipage}[c]{0.5\linewidth}
          Director: Elías Moreno Bas.\\
    \pause
      Planteamiento:
      \begin{itemize}
      \item Espacio paramétrico $\Theta$, con sigma-álgebra
        $\mathcal{A}$.
      \item Un espacio de decisiones $\mathcal{B}$
      \item Para cada decisión $d$ en $\mathcal{B}$, el riesgo $r(d,
        \theta)$ de \\
        
        tomar la decisión $d$ cuando $\theta$ es el verdadero
        valor del parámetro.
      \item La distribución a priori es sólamente conocida\\
        
        sobre una
        sub $\sigma$-álgebra de $\mathcal{A}$.
      \end{itemize}
      Por lo tanto, el riesgo Bayesiano no se puede calcular.\\
      \pause
      $\Rightarrow$ se considera el método Media-Max para cálculo del riesgo.
    \end{minipage}
  \end{tabular}
  \end{frame}
  \begin{frame}\frametitle{Tesis doctoral, U. Granada, 1984}
    \begin{tabular}{cc}
    \begin{minipage}[c]{0.5\linewidth}
      \includegraphics[width=5.5cm]{images/tesis.png}
    \end{minipage} &   \begin{minipage}[c]{0.5\linewidth}
      Obtiene varios resultados relevantes:
      \begin{itemize}
      \item Una formulación analítica alternativa del riesgo Media-Max y la
        determinación de sus propiedades.
      \item un estudio comparativo del método Media-max y competidores.
      \item Resultados de aproximación asintótica para estimadores
        óptimos con el método Media-Max.
      \end{itemize}
    \end{minipage}
\end{tabular}
\end{frame}
...
\begin{frame}\frametitle{Tesis doctoral, U. Granada, 1984}
  \begin{tabular}{cc}
    ...
    \end{minipage} &   \begin{minipage}[c]{0.5\linewidth}
    \begin{block}{}
            Una tesis con contribuciones relevantes, que exigieron un alto
      nivel técnico: manejo de $\sigma$-álgebras, conceptos de
      medibilidad, suficiencia, esperanzas condicionadas complejas, y
      un dominio de los teoremas de convergencia.\\
      La clave fue el considerar  una derivada generalizada de Radon-Nikodym
    \end{block}\medskip
    \pause
    \textbf{Nota: }Durante la realización de la tesis, fue Prof. adjunto interino de
    la Universidad de Murcia desde finales de 1979 hasta inicios de 1984.
    \end{minipage}
\end{tabular}
\end{frame}
  \begin{frame}
    \frametitle{Las secuelas de la tesis doctoral: 1984 - 1988/89}
    \begin{block}{}1984: Profesor Titular contratado en la U. Murcia.
    \end{block}
    Durante este periodo, publicó una serie de artículos en revistas
    internacionales, en temáticas próximas a la tesis: \pause
    \begin{itemize} \footnotesize
    \item Cano, J.A., Hernández, A. y E. Moreno
\textit{ Posterior measure under partial prior information.
} Statistica, 1986
\item Cano, J.A., Hernández, A. y E. Moreno
\textit{ Conditioning with upper integral. Upper sufficiency.
} Pub. Inst. Stat. Univ. París, 1987
\item Cano, J.A., Hernández, A. y E. Moreno
\textit{ A short note on the J-minimax and mean-max risk functions.
} Pub. Inst. Stat. Univ. París, 1987

\item Cano, J.A., Hernández, A. y E. Moreno
\textit{ On minimum risk parameter under partial prior information.
} Pub. Inst. Stat. Univ. París, 1987
\item Cano, J.A., Hernández, A. y E. Moreno
\textit{ A note on maximized likelihood sets.
} Eur. J. of Oper. Res, 1987
\end{itemize}\pause
 \begin{block}{}1987: Profesor Titular funcionario en la U. Murcia.
    \end{block} \pause
\begin {itemize} \footnotesize   
\item Cano, J.A., Hernández, A. y E. Moreno
\textit{ On Kolmogorov' s partial sufficiency} Bayesian Statistics, 1988
\item Cano, J.A., Hernández, A. y E. Moreno
\textit{ On the L-sufficiency concept of partial sufficiency.
} Statistica, 1989.
    \end{itemize}
  \end{frame}
  \begin{frame}
    \frametitle{Cambio de rumbo: robustez Bayesiana}
    \begin{block}{}
      Al final de la década de los 80, redirige su actividad hacia la
    robustez Bayesiana: estudio de la sensibilidad de los
    métodos Bayesianos a la incertidumbre en los componentes del
    problema.
  \end{block}\pause 
  \begin{itemize}
  \item   Especialmente importante ante la dificultad de escoger de manera precisa
    la distribución a priori.
  \item     Requiere del mismo tipo de técnicas que ha llegado a dominar con
    la especificación  parcial de la distribución a priori.

  \end{itemize} \pause
  $\Rightarrow $ En 1988, su primer artículo en esta temática.
\end{frame}
\begin{frame}
  \frametitle{Cambio de rumbo: robustez Bayesiana}
  En 1989, un gran resultado: \pause
  \includegraphics[width=10 cm]{images/jrssb}
  \pause
  \begin{block}{}
    \begin{itemize}
    \item Alto nivel.
    \item Perfecta ejecución técnica
    \end{itemize}
  \end{block}
...
\begin{frame}
  \frametitle{Cambio de rumbo: robustez Bayesiana}
    \begin{center}
    \Ovalbox{ \Large Estancia en Purdue University, West Lafayette}
  \end{center}\pause
  \begin{center}
    \includegraphics[width=10cm]{images/beca_OTAN_v2.png} \medskip    
  \end{center}

  \pause
   Professor James Berger, Curso 1989/90.
\begin{center}
    \includegraphics[width=9cm]{images/berger}
  \end{center}
\end{frame}
\begin{frame}
  \frametitle{A la vuelta de Purdue}
  \begin{overlayarea}{\textwidth}{\textheight}
  \begin{center}
    \Ovalbox{ \Large Una decada intensa: 1990-2000}
  \end{center}

  Vuelve con muchas ganas.\\ \pause
  \begin{minipage}[c]{0.5\linewidth}
  \begin{block}{}
    Crea un grupo de investigación, 1990.
  \end{block}    
  \end{minipage}
\pause
  \begin{center}
      \includegraphics[width=6.5cm]{images/constitucion_grupo_investigacion}
    \end{center}\pause
    Publica varios artículos en robustez Bayesiana.\\ \pause
     \hfill\begin{tabular}{cc}
    \begin{minipage}[b]{0.3\linewidth}
   \begin{block}{}
    !Se casa! 1991
  \end{block}      
    \end{minipage}& \includegraphics[width=1cm]{images/wedding_rings}      
    \end{tabular}
\pause
    \begin{tabular}{ccc}
    \begin{minipage}[b]{0.55\linewidth}
   \begin{block}{}
    Nacimiento de Pilar, 1994\onslide<7->{, Carmen, 1996}
  \end{block}      
    \end{minipage}& \includegraphics[width=0.7cm]{images/stork}&\onslide<7->{\includegraphics[width=0.7cm]{images/stork}}
    \end{tabular}\\
  \end{overlayarea}  
\end{frame}
...
\begin{frame}
   ...
   \begin{block}{}
    1996: Estancia en Paris, 6 meses,\onslide<2->{ Kyoto, 1 mes}
  \end{block}      
    \end{minipage}&
                    \includegraphics[width=1cm]{images/eiffel}&\onslide<2->{\includegraphics[width=1cm]{images/japan}}
                                                                     
   \end{tabular}\onslide<3->
   \begin{center}
     \begin{tabular}[h]{cc}
       \includegraphics[height=6cm]{images/paris}&
                                                   \includegraphics[height=6cm]{images/kyoto}
     \end{tabular}
   \end{center}
  \end{overlayarea}
...
\begin{frame}
   ...
   \begin{tabular}{ccc}
    \begin{minipage}[b]{0.7\linewidth}
   \begin{block}{}
    1996: Estancia en Paris, 6 meses, Kyoto, 1 mes
  \end{block}      
    \end{minipage}&
                    \includegraphics[width=1cm]{images/eiffel}&\includegraphics[width=1cm]{images/japan}
                                                                     
   \end{tabular}\bigskip
   \begin{center}
     \begin{tabular}[h]{ccc}
       \includegraphics[width=1cm]{images/party}&
     \Ovalbox{\begin{minipage}[b]{0.4\linewidth}
         \begin{center}\Large
           Promoción a Catedrático de Universidad: 2000.
         \end{center}
       \end{minipage}}&       \includegraphics[width=1cm]{images/party}       
     \end{tabular}
...
\begin{frame}
    \frametitle{Ya catedrático}
    \begin{overlayarea}{\textwidth}{\textheight}
      \begin{center}
        \Ovalbox{ \Large Decada  2000 - 2010}
      \end{center}
      Ampliación de las temáticas de investigación:\medskip
      \begin{itemize}
      \item Inferencia Bayesiana para procesos estocásticos.
        \begin{itemize}
        \item Aproximaciones númericas vía MCMC\smallskip
        \item Aproximaciones analíticas, basados en teoremas de convergencia para comportamiento asintótico.
        \end{itemize}
      \item Inferencia Bayesiana Objetiva ``OBayes'', para selección
        de modelos.
   ...
   \begin{block}{}
    Nacimiento de Juan, 2003
  \end{block}      
    \end{minipage}& \includegraphics[width=0.7cm]{images/stork}
    \end{tabular}\\ \pause
       \hfill \begin{tabular}{cc}
    \begin{minipage}[b]{0.4\linewidth}
   \begin{block}{}
    Doctorado de Diego, 2006
  \end{block}      
    \end{minipage}& \includegraphics[width=0.7cm]{images/doctor}
              \end{tabular}\\
  \end{overlayarea}
...
\begin{frame}
  ...
  \end{block}      
   ...
   \begin{block}{}
    Doctorado de Carmen Carazo, 2008
  \end{block}      
    \end{minipage}& \includegraphics[width=0.7cm]{images/doctor}
              \end{tabular}\pause   \\
       \hfill   \begin{minipage}[b]{0.6\linewidth}
   \begin{block}{}
    Curso 2008/09: supera un línfoma de Hodgkin
  \end{block}      
    \end{minipage}
  \end{overlayarea}
...
\begin{frame}
    ...
    \begin{overlayarea}{\textwidth}{\textheight}
      \begin{center}
        \Ovalbox{ \Large   2010 - 2018}
      \end{center}\vspace{-0.2cm}\pause
      \begin{block}{Investigación:} Propuesta y estudio de una clase de
      distribuciones a priori objetivas, las ``integral priors'', para
      la selección de modelos.  
      \end{block}\pause
       En la última parte de la tesis de Diego, colaboración con Christian
        Robert, CREST Paris.
            \pause
      \begin{center}
        \includegraphics[height=3cm]{images/cano_salmeron_robert}
      \end{center} \pause
      Factor Bayes basado en default priors
      $\pi_i^N = c_ih_i(\theta_i)d\theta_i,\ i=1, 2$,
      $$B^N_{21}(x) = \frac{m_2^N(x)}{m_1^N(x)} =
      \frac{c_2\int_{\Theta_2}f_2(x|\theta_2)h_2(\theta_2)d\theta_2}{
        c_1\int_{\Theta_1}f_1(x|\theta_1)h_1(\theta_1)d\theta_1}$$
      \pause
      Problema de indeterminación de $c_2 / c_1$.
  \end{overlayarea}
...
\begin{frame}
    ...
    \begin{overlayarea}{\textwidth}{\textheight}
      ...
      la selección de modelos.  
    \end{block}
    Las ``integral priors'' son solución de un sistema de ecuaciones
      \begin{align*}
\pi _{1}(\theta _{1})&=\int_{\mathcal{X}}\pi _{1}^{N}(\theta
_{1}\mid x)m_{2}(x)dx,\\
\pi _{2}(\theta _{2})&=\int_{\mathcal{X}}\pi _{2}^{N}(\theta
_{2}\mid x)m_{1}(x)dx.
      \end{align*}\pause
      \begin{itemize}
      \item Dan una condición suficiente para la existencia y unicidad de
      las soluciones. Está asociada a la recurrencia de una Cadena de
      Markov.
      \item<3-> Se trata de una mejor solución que las ``intrinsic
        priors'' de Berger \& Perichi (1996).
        \item<4-> Obtiene las integral priors para una serie de
          problemas clásicos de selección de modelos.
      \end{itemize}
  \end{overlayarea}
...
\begin{frame}
  \begin{center}
    \includegraphics[height=0.9\textheight]{images/sketch_JA_M.png}
  \end{center}
\end{frame}
\begin{frame}
  \begin{center}
    \includegraphics[height=0.9\textheight]{images/con_Mathieu}
  \end{center}
\end{frame}
\end{document}
\begin{frame}
  \begin{itemize}
  \item 1996: estancia en Paris, 6 meses
  \item 1996, estancia corta en Kyoto, con charla
  \item 2002: Curso MCMC en Granada, con George Casella
  \item 2004: estancia en CREST, 2 meses   
  \item 2005/06: grupo de trabajo R
  \end{itemize}
\end{frame}
\end{document}
